  ...
  return (
    <CommonWrapper>
      <section className="flex flex-col gap-[30px] justify-center pl-[12%] max-[1024px]:pl-[0%]">
        <TitleComponent
          title="About"
          content="Eazy Gaming, founded by experienced and passionate industry experts, develops top-notch slot games worldwide. We also offer a fishing game, providing rich gaming options for online entertainment operators."
        ...
        />
            ...
            >
              <div className="p-[20px]">
                ...
                Our RNG games are certified by BMM, a leading global game testing agency. We meet all legal and technical requirements in most European jurisdictions.
            ...
            return (
              ...
              >
                ...
                >
                  <div className="p-[20px]">
                    <p
                      className="text-[27px] font-bold mb-[10px] title-font"
                    >
                      {card.title}
                    </p>
                    <p className="text-sm max-[1024px]:text-xs">{card.content}</p>
                  </div>
                </section>
