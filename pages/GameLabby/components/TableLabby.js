...
const TableLabby = () => {
  ...
  return (
    <section
      ref={ref}
      className="container h-full mx-auto flex md:flex-row flex-col items-center justify-between max-[640px]:px-[20px]"
    >
      <motion.div
      ...
      >
        <p className="text-[45px] font-medium barcarat-text-left mb-[40px] max-[640px]:text-xl">
          桌上版大廳
        </p>
      ...
      >
        <p className="text-[45px] font-medium barcarat-text-right mb-[40px] max-[640px]:text-xl">
          H5 移動版
        </p>
        <p className="max-[640px]:text-sm">
          我們的 H5
