...
const FishGames = () => {
  return (
    <>
      ...
      >
        <section className="container mx-auto text-white flex items-center justify-start h-full max-[1024px]:px-[20px]">
          <div className="max-[1024px]:mb-[40%]">
            <p className="text-[50px] font-medium text-myself-shadow mb-[30px] max-[1024px]:text-2xl">
              捕魚遊戲
            </p>
            <p className="w-[500px] max-[1024px]:w-auto max-[1024px]:text-sm">
              除了老虎機遊戲，SimplePlay
