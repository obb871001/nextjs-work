        ...
        <section className="container mx-auto max-[640px]:px-[20px]">
          <section className="flex max-[640px]:flex-col items-center justify-center mb-[40px]">
            <div className="text-white mb-[20px] max-[640px]:text-center">
              ...
              <p>
              區塊鏈遊戲<br></br>體驗最刺激、最快節奏的即時遊戲!利用你的直覺和洞察力開始一場冒險，希望你的選擇能帶來最豐富的回報。借助創新技術，每場遊戲都經過驗證，以確保絕對公平和公正。
              </p>
            </div>
        ...
        <section className="container mx-auto max-[640px]:px-[20px]">
          <section className="grid grid-cols-2 max-[640px]:grid-cols-1 gap-2">
            <GameIntroduce
              ...
              playGameLink="https://d29juml4m9n88c.cloudfront.net/games/crash/blastxp/?lang=en&curr=usd&useIFrame=true&hideTxID=true"
            />
            <GameIntroduce
              intro="《Plinko》希望球落入最高賠率的槽位"
              gameModal="url(/Images/SlotGames/games/games1Modal.png)"
              gameBackground="url(/Images/SlotGames/games/games1.jpeg)"
              gameIcon="/Images/SlotGames/games/games1Icon.png"
              playGameLink="https://d29juml4m9n88c.cloudfront.net/games/crash/plinkop/?lang=en&curr=usd&useIFrame=true&hideTxID=true"
            />
            <GameIntroduce
              intro="《Hi-Lo》擁抱翻牌的刺激時刻"
              gameModal="url(/Images/SlotGames/games/games1Modal.png)"
              gameBackground="url(/Images/SlotGames/games/games1.jpeg)"
              gameIcon="/Images/SlotGames/games/games1Icon.png"
              playGameLink="https://d29juml4m9n88c.cloudfront.net/games/crash/hilop/?lang=en&curr=usd&useIFrame=true&hideTxID=true"
            />
            <GameIntroduce
              intro="《Wheel》期待著轉盤停在最高派彩的區域"
              gameModal="url(/Images/SlotGames/games/games1Modal.png)"
              gameBackground="url(/Images/SlotGames/games/games1.jpeg)"
              gameIcon="/Images/SlotGames/games/games1Icon.png"
              playGameLink="https://d29juml4m9n88c.cloudfront.net/games/crash/wheelp/?lang=en&curr=usd&useIFrame=true&hideTxID=true"
            />
            <GameIntroduce
              intro="《Dice》投擲骰子，看看你的預測是否成真"
              gameModal="url(/Images/SlotGames/games/games1Modal.png)"
              gameBackground="url(/Images/SlotGames/games/games1.jpeg)"
              gameIcon="/Images/SlotGames/games/games1Icon.png"
              playGameLink="https://d29juml4m9n88c.cloudfront.net/games/crash/dicep/?lang=en&curr=usd&useIFrame=true&hideTxID=true"
            />
          </section>
        </section>
      </section>
