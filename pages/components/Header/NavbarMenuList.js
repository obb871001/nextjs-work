...
const NavbarMenuList = () => {
  ...
  const navigationItems = [
    {
      icon: (
        <AiFillHome className="text-white text-3xl hover:!text-light-yellow-text" />
      ),
      id: "Home",
      label: "Home",
    ...
    {
      icon: (
        <BsFire className="text-white text-3xl hover:!text-light-yellow-text" />
      ),
      id: "HotGame",
      label: "Hot",
      href: "/HotGame",
    ...
    {
      icon: (
        <BsDice5Fill className="text-white text-3xl hover:!text-light-yellow-text" />
      ),
      id: "BeABanker",
      label: "BeABanker",
      href: "/#",
    ...
    {
      icon: (
        <FaFish className="text-white text-3xl hover:!text-light-yellow-text" />
      ),
      id: "Fishing",
      label: "Fishing",
      href: "/#",
    ...
    {
      icon: (
        <SiBlockchaindotcom className="text-white text-3xl hover:!text-light-yellow-text" />
      ),
      id: "Blockchain",
  ...
  return (
    <AnimatePresence>
      ...
      >
        <div
          className={`fixed h-full left-0 top-0 z-10 w-[12%] max-[1024px]:z-[9999] flex flex-col justify-between
        ...
        ${isMenuOpen ? "max-[1024px]:h-full" : "max-[1024px]:h-auto"}`}
          style={{
            ...
            boxShadow: isMenuOpen
              ? "2px 2px 2px rgba(20%,20%,40%,0.6),4px 4px 6px rgba(20%,20%,40%,0.4),6px 6px 12px rgba(20%,20%,40%,0.4)"
              : "unset",
          }}
          ref={menuRef}
        >
          ...
          {/* mt-40 max-[1024px]:mt-[68px] */}
          <div
            className={`absolute top-0 left-0 flex flex-col mt-40 max-[1024px]:mt-[68px] items-center justify-center w-full ${
              isMenuOpen ? "max-[1024px]:block" : "max-[1024px]:hidden"
            }`}
          >
            <section className="h-full w-full flex flex-col items-center justify-center">
              <div className="navigation-body max-[1024px]:w-full">
                <div className="navigation-group-wrap w-full flex flex-col ">
                  <div className="navigation-group flex flex-col items-start justify-start">
                      ...
                      >
                        <Link href={item.href} passHref>
                          ...
                          >
                            {item.icon}
                            {isMenuOpen && (
                              <div className="title-font hover-box text-white px-4">
                                {i18nCommon(item.label)}
                              </div>
                            )}
                          </div>
                        </Link>
                    ...
                    <div className="title-font bg-black text-white flex w-full items-center text-base min-[1024px]:hidden">
                      <div
                        className={`navigation-item flex flex-col items-start justify-start w-full px-4 py-2 ${
                          isMenuOpen ? "px-10 py-4" : "p-4"
                        }`}
                      >
                        {menuItems.map((menuItem) => (
                          ...
                          >
                            <div
                              className={`title-font text-white px-4 py-2 flex w-full items-center cursor-pointer text-base 
                                    ${isMenuOpen ? "px-10 py-4" : "p-4"}`}
                            >
